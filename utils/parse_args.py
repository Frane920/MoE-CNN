...
def parse_args():
    ...
    p.add_argument('--resume', type=str, default='best_model.pt')
    ...
    p.add_argument('--swa_start', type=int, default=100, help='Epoch to start SWA (defaults to 75% of total epochs)')
    p.add_argument('--k_per_specialization', type=int, default=1, help='Number of experts to select per specialization')
