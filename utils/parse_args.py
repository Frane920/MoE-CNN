...
def parse_args():
    ...
    p.add_argument('--label_smoothing', type=float, default=0.07)
    ...
    p.add_argument('--mixup_alpha', type=float, default=0.6)
    ...
    p.add_argument('--penalty_weight', type=float, default=0.1)
