...
def parse_args():
    ...
    p.add_argument('--noise_std', type=float, default=0.010)
    p.add_argument('--rand_erase_p', type=float, default=0.15)
    ...
    p.add_argument('--cutmix_alpha', type=float, default=0.8)
    ...
    p.add_argument('--penalty_weight', type=float, default=2000)
